...
const preset = ref<PresetKey>(layoutConfig.preset);
...
const primaryColors = ref<Preset[]>([
  { name: "noir", palette: {} },
  {
    name: "emerald",
    palette: {
...
function applyTheme(type: "primary" | "surface", color: Preset) {
  if (type === "primary") {
